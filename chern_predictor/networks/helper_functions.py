...
def load_data(
    ...
    if load_training_data:
        with open(os.path.join(dataset_directory, "training.dat"), "r") as file:
    ...
    if load_validation_data:
        with open(os.path.join(dataset_directory, "validation.dat"), "r") as file:
    ...
    if load_test_data:
        with open(os.path.join(dataset_directory, "test.dat"), "r") as file:
